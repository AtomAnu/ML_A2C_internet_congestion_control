...
for i in range(len(a3c_t)):
    ...
    if count == 2000:
        count = 0
        a_throughput_list.append(a_throughput_sum/(1000*1000))
        n_throughput_sum = n_throughput_sum/(1000*1500)
        n_throughput_list.append(n_throughput_sum)
        reno_throughput_list.append(reno_throughput_sum/(1000*1000))
        a_throughput_sum = 0
        n_throughput_sum = 0
        reno_throughput_sum = 0
